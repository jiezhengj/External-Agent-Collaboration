...
- P4 已完成有限的自动只读 role router 与 macOS/Windows smoke：只有新主题、无敏感、明确独立审查且 profile ready 时选择 Antigravity；未就绪、非标准 contract、execute/draft 或跨 harness 歧义均明确拒绝或交回 Codex，不静默替代。
