...
|全局 Skill 生产加固、跨项目调用与失败案例闭环|待实施；本文定义 P0/P1 发布阻断项、Luna–Codex 持续 Goal/Review Gate 和双平台完成契约|2026-08-05 全仓质量评审、DriversLicense 跨项目独立复核失败、当前 34 项回归基线|[2026-08-05-global-skill-production-hardening](2026-08-05-global-skill-production-hardening/README.md)|
