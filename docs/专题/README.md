...
|全局 Skill 生产加固、跨项目调用与失败案例闭环|施工中；运行时加固、50 项回归、CI 四矩阵和 macOS 真实只读 smoke 已完成，Windows 真实 provider smoke、coverage 与 8 个 WP accepted packet 仍阻断发布|2026-08-05 全仓质量评审、DriversLicense 跨项目独立复核失败、当前 50 项回归证据|[2026-08-05-global-skill-production-hardening](2026-08-05-global-skill-production-hardening/README.md)|
