...
|Headless multi-harness architecture|P0/P1/P2 macOS 已验证；Windows 真机验收待执行|Claude Code、Antigravity 官方 headless 参考与 2026-07-31 架构决策|[专题入口](2026-07-31-headless-multiharness/README.md) · [Windows Codex 接手](2026-07-31-headless-multiharness/WINDOWS_HANDOFF.md)|
