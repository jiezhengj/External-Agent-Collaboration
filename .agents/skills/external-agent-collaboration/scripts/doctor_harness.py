...
def check(profile_name: str) -> dict[str, object]:
    profiles = load_profiles(collaborate.CONTROL_ROOT)
    ...
    return {
        "harness": "antigravity", "profile": profile_name, "ok": not problems and trusted(collaborate.CONTROL_ROOT, profile_name, profile),
        "profile_trusted": trusted(collaborate.CONTROL_ROOT, profile_name, profile), "interactive_authentication": "not_checked_without_a_real_request",
        "problems": problems,
    }
